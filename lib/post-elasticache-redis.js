...
const config = {
	service    : 'Redis',
	debug      : configuration.getEnvBool('DEBUG_MODE', false),                // Activate debug messages
	refreshRate: configuration.getEnvNumber('REDIS_SERVER_REFRESH', 60) * 1000 // Refresh server list every minute
};
