...
// Add the "always" function to the specified prototype
// usage: util.ensureAlways(Promise.prototype);
module.exports.ensureAlways = (proto) => {
	if(typeof(proto.always) != "function") {
