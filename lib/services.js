...
const defaultValues = {
  ...
  stsSessionDuration: configuration.getEnvironmentVariable('STS_SESSION_DURATION', 3600),
  stsSessionName    : configuration.getEnvironmentVariable('STS_SESSION_NAME', "Lambda")
};
...
const sts           = new AWS.STS({ region: currentRegion });; // STS service for impersonation of roles in the fan-out process 
