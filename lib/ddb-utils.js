...
function parseDynamoDBObject(value, defaultValues, options) {
	const result = util.duplicate(defaultValues || {});
	if ((value === null) || (value === undefined)) {
		return result;
	}
...
module.exports.generateDynamoDBProperty = generateDynamoDBProperty;
module.exports.generateDynamoDBObject = generateDynamoDBObject;
module.exports.parseDynamoDBObject = parseDynamoDBObject;
module.exports.parseDynamoDBPropertyValue = parseDynamoDBPropertyValue;
